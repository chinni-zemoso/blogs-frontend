...
export const getAllPosts = async () => {
  const fetchedPostsJson = await fetch(URL.getAllPostsURL, {
    method: "GET",
    headers: {
  ...
  const fetchedUsersJson = await fetch(URL.getAllUsersURL, {
    method: "GET",
    headers: {
      "content-type": "application/json",
      accept: "application/json",
...
export const storeBlogComment = async () => {
  await fetch(urls.storeCommentsURL, {
    method: "POST",
    headers: {
      "content-type": "application/json",
      accept: "application/json",
